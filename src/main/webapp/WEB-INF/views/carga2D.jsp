...
<div class="container">
    ...
    <form id="cargarImaxes" action="<c:url value='/procesar2D'/>" method="POST" enctype="multipart/form-data">
        <div class="row justify-content-center ">
            <div class="col-md-11 inter">
                <div class="row mt-3">
                    <div class="col-6">
                        <label for="exampleFormControlFile1">Imagen 0h gris</label>
                        <input type="file" class="form-control-file" name="imagen0hg" id="exampleFormControlFile1"
                               accept="image/*">
                    </div>
                    <div class="col-6">
                        <label for="exampleFormControlFile1">Imagen 24-48-72h gris</label>
                        <input type="file" class="form-control-file" name="imagen72hg" id="exampleFormControlFile2"
                               accept="image/*">
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-6">
                        ...
                        <input type="file" class="form-control-file" name="imagen0hf" id="exampleFormControlFile3"
                               accept="image/*" required>
                    </div>
                    <div class="col-6">
                        <label for="exampleFormControlFile1">Imagen 24-48-72h fluorescencia</label>
                        <input type="file" class="form-control-file" name="imagen72hf" id="exampleFormControlFile4"
                               accept="image/*" required>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 mediun">
                <div class="form-group">
                    <div class="row">
                        <div class="col">
                            <label>Inicio:</label>
                            <input class="form-control" type="number" name="Inicio" value="0" readonly>
                        </div>
                        <div class="col">
                            <label>Fin:</label>
                            <input class="form-control" type="number" name="Fin" value="50" min="5"
                                   data-bind="value:replyNumber" required>
                        </div>
                        <div class="col">
                            <label>Paso:</label>
                            <input class="form-control" type="number" name="Paso" value="5" min="1"
                                   data-bind="value:replyNumber" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col text-right">
                            <input class="btn orange text-white" name="carga-imaxes2d" type="submit" value="Procesar"/>
                        </div>
                    </div>
                </div>
            </div>
