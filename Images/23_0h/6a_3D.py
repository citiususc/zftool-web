...
data_0= np.array([io.imread('/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/6a/20140331-HCT 116-GFP_6a_10x_z0%i_ch00.tif' % i) for i in range(0, 10)])
data_0= np.concatenate((data_0,np.array([io.imread('/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/6a/20140331-HCT 116-GFP_6a_10x_z%i_ch00.tif' % i) for i in range(10, 42)])),axis=0)
data_0=data_0[:,:,:,1]
data_0=data_0.T
...
"""este for va en función del número de imágenes:42"""  
...
def volumen_voxels(imagen):
    ...
    f=open("/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/6a/datos.txt","w")
    for nG in nGFP:	
    	f.write(str(nG))
    	f.write(" ")
    f.write("\n")	
