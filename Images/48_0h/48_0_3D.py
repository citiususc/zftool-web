...
data_0= np.array([io.imread('/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/48_0h/pez 48_0%i.tif' % i) for i in range(0, 10)])
data_0= np.concatenate((data_0,np.array([io.imread('/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/48_0h/pez 48_%i.tif' % i) for i in range(10, 29)])),axis=0)
data_0=data_0[:,:,:,1]
data_0=data_0.T
...
"""este for va en función del número de imágenes:29"""  
...
def volumen_voxels(imagen,umbral):
    ...
    f=open("/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/48_0h/datos1.txt","w")
    for nG in nGFP:	
    	f.write(str(nG))
    	f.write(" ")
    f.write("\n")	
...
f=open("/home/marcos/Escritorio/TFG_peixe_cebra/Codigo/AppZebraFish/Images/48_0h/datos1.txt","a")
f.write(str(list(zip(*np.where(vol>25)))))
f.close()
