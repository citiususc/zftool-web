        ...
        <div class="col-md-11 inter">
          <div class="row mt-3">
            <div class="col-6">
                  ...
                  <input type="file" class="form-control-file" name="imagen0h3D[]" id="exampleFormControlFile1" accept="image/*" multiple required>
            </div>
            <div class="col-6">
                  <label for="exampleFormControlFile1">Imágenes 24-48-72h </label>
                  <input type="file" class="form-control-file" name="imagen72h3D[]" id="exampleFormControlFile2" accept="image/*" multiple required>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12 mediun">
          <div class="form-group">
              <div class="row">
                <div class="col">
                  <label>Inicio:</label>
                  <input class="form-control" type="text" name="Inicio_3D" value="0" readonly>
                </div>
                <div class="col">
                  <label>Fin:</label>
                  <input class="form-control" type="text" name="Fin_3D" value="50" required>
                </div>
                <div class="col">
                  <label>Paso:</label>
                  <input class="form-control" type="text" name="Paso_3D" value="5" required>
                </div>
